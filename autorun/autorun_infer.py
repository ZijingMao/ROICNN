...
def inference_roicnn(images, keep_prob, layer=2, feat=[2, 4]):
    ...
    # conv_tensor = rsvp_quick_inference.inference_pooling_n_filter(conv_tensor, kheight=2, kwidth=2)
    conv_tensor = rsvp_quick_inference.inference_pooling_l2norm_filter(conv_tensor, kwidth=2)
